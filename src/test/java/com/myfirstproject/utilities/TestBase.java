...
//        Done with configuration......
    ...
    public void tearDown(){
        //driver.quit();
        extentReports.flush();  //Generating and Ending the report
    }
    ...
    *
    *           selectCheckBox(checkbox1, true); make sure checkbox is checked
    *           selectCheckBox(checkbox1, false); make sure checkbox is unchecked
    */
...
//      1. Step : Taking screenshot using getScreenshotAs
