...
//        NOTE: Getting the window handle of the first window
//        I need this so I can switch back to this window
        String window1Handle = driver.getWindowHandle();  //WindowHandle means window id
...
//        Then user verifies the new window title is “New Window”
        Set<String> allWindowHandles = driver.getWindowHandles(); //WindowHandle means window id
        System.out.println(allWindowHandles);

//          We must switch to the 2nd window
        for(String eachHandle : allWindowHandles){//if each handle is NOT equal to window1 handle
