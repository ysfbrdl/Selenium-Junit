...
//        Open the first worksheet
  //  getSheetAt(0); accepts an integer and is used to get the specific sheet to go to 1st sheet use index of 0.
        Sheet sheet1=workbook.getSheetAt(0);

//        Go to first row
        /*getRow(0); accepts an integer and is used to get the specific row to go to 1st row use index of 0*/
        Row row1=sheet1.getRow(0);

//        Go to first cell on that first row and print
        /*getCell(0) accepts an integer and is used to get the specific cell to go to 1st cell use index of 0*/
        Cell cell1 = row1.getCell(0);
        System.out.println(cell1);
        /*Cell objects can be converted to a string easility
         * We may need to convert to a string if we need to manupilate the data
